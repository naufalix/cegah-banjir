                        ...
                        <div data-kt-search-element="wrapper">
                          ...
                          <div data-kt-search-element="results" class="d-none">
                            ...
                            <div class="scroll-y mh-200px mh-lg-350px">
                              ...
                              <!--begin::Item-->
                              <a href="../dist/documentation/general/tiny-slider/advanced.html" data-kt-searchable="true" class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                              ...
                              <!--end::Item-->
                              <!--begin::Item-->
                              <a href="#" data-kt-searchable="true" class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                              ...
                              <!--end::Item-->
                              <!--begin::Item-->
                              <a href="../dist/documentation/icons/bootstrap-icons.html" data-kt-searchable="true" class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                              ...
                              <!--end::Item-->
                              <!--begin::Item-->
                              <a href="../dist/documentation/icons/font-awesome.html" data-kt-searchable="true" class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                              ...
                              <!--end::Item-->
                              <!--begin::Item-->
                              <a href="../dist/documentation/icons/line-awesome.html" data-kt-searchable="true" class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                          ...
                          <div class="mb-0" data-kt-search-element="main">
                            ...
                            <div class="scroll-y mh-200px mh-lg-325px">
                              ...
                              <!--end::Item-->
                              <!--begin::Item-->
                              <a href="#" class="d-flex flex-column text-dark text-hover-primary py-2">
                              ...
                              <!--end::Item-->
                              <!--begin::Item-->
                              <a href="../dist/documentation/general/fullcalendar/overview.html" class="d-flex flex-column text-dark text-hover-primary py-2">
