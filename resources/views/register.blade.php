...
<div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url(/ceres-html-pro/assets/media/illustrations/dozzy-1/14.png">
  ...
  <div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
    <!--begin::Wrapper-->
    <div class="col-md-6 bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
      <div class="row mb-10">
        {{-- <img alt="Logo" src="/assets/img/logo.png" class="h-70px w-auto mx-auto" /> --}}
      ...
      <form method="post" class="form w-100" novalidate="novalidate" id="kt_sign_in_form" action="" method="post">
        ...
        <div class="row mb-10">
          <div class="col-md-6 mb-10">
            ...
            <input class="form-control form-control-lg form-control-solid" type="text" name="location" required placeholder="Kota/kabupaten"/>
          </div>
          <div class="col-md-6 mb-10">
        ...
        <div class="text-center">
          <button type="submit" id="kt_sign_in_submit" name="login" class="btn btn-lg btn-success w-100 mb-5">
