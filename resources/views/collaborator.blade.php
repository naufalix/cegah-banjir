  ...
  <div class="container px-md-5" data-aos="fade-up" data-aos-delay="100">
    ...
    <div class="row gy-4">
      ...
      <div class="col-lg-8 row">
        <div class="col-md-4">
          <img class="rounded-circle" src="/assets/img/user/{{ $user->image ? $user->image : 'default.webp' }}" style="width: 100%">
        </div>
        <div class="col-md-8">
      ...
      <div class="col-lg-4">
        ...
        @foreach ($users as $u)
        <a href="/kolaborator/{{$u->username}}" data-aos="fade-up" data-aos-delay="200" >
