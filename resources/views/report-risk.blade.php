  ...
  <div class="container px-md-5" data-aos="fade-up" data-aos-delay="100">
    ...
    <div class="row gy-4">
      ...
      <div class="col-lg-8">
        ...
        <div class="row">
          <div class="col-6">
            <img class="mb-4 img-fluid services-img border rounded" src="/assets/img/flood/{{$risk->image}}" alt="" style="width:100%; aspect-ratio: 16/10; object-fit: cover">
          </div>
          <div class="col-6">
      ...
      <div class="col-lg-4">
        <div class="card" data-aos="fade-up" data-aos-delay="200" style="border-radius:16px; padding: 20px">
          ...
          <hr>
          <p class="mb-0" style="font-size: 14px"><strong>Penyebab</strong> : {{$risk->cause->name}}</p>
